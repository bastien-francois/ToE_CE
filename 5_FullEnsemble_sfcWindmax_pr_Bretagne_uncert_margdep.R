...
#Mod="CDFt_pooled_ModRefCNRMCM6"
#Ref_SlidingWindow="1850_1879"
print(Mod)
...
b_probs_95_listX_index1[coord_Ref_SlidingWindow,,]=boot_param_GPD(tmp_listX_index1, quant90_index1,
                                            quant_Init_index1,B, level_=0.95)
b_probs_95_listX_index2[coord_Ref_SlidingWindow,,]=boot_param_GPD(tmp_listX_index2, quant90_index2,
                                            quant_Init_index2, B, level_=0.95)
  ...
  for(f in best_family_final[[Mod]]){#family_to_try){
   ...
   if(k!=coord_Ref_SlidingWindow){
    ...
    b_probs_68_listX_index2[k,,]=boot_param_GPD(tmp_listX_index2, quant90_index2,
                                            quant_Init_index2, B, level_=0.68)
    b_probs_95_listX_index1[k,,]=boot_param_GPD(tmp_listX_index1, quant90_index1,
                                            quant_Init_index1,B, level_=0.95)
    b_probs_95_listX_index2[k,,]=boot_param_GPD(tmp_listX_index2, quant90_index2,
                                            quant_Init_index2, B, level_=0.95)
   }
